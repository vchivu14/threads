...
effectanswer2 = EffectAnswer(user_id=1, name="gauge", solution="plant more trees",
                             importance="high", area="global", cause=platform1)
...
effectanswer1 = EffectAnswer(user_id=1, name="bob", solution="train more teachers",
                             importance="high", area="global", cause=platform2)

session.add(effectanswer1)
session.commit()

effectanswer2 = EffectAnswer(user_id=1, name="jessie", solution="bring more involved people",
                             importance="high", area="global", cause=platform2)
...
effectanswer1 = EffectAnswer(user_id=1, name="roxanne", solution="bring more funds",
                             importance="medium", area="local", cause=platform3)
